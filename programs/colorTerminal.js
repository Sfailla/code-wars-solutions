...
export const colorTerminal = terminalColor => {
...
console.log(colorTerminal(''), 'please enter a valid color as argument')
console.log(colorTerminal('yel'), 'sorry that color is not available')
